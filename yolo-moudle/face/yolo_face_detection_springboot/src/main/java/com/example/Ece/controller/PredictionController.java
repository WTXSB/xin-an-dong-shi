    ...
    public Result<?> predict(@RequestBody PredictRequest request) {
        ...
        try {
            ...
            if (responses.get("status").equals(400)) {
                ...
                if (!Boolean.FALSE.equals(request.getKeepRecord())) {
                    ...
                    imgRecords.setInputImg(Boolean.TRUE.equals(request.getKeepMedia()) ? request.getInputImg() : "");
                    ...
                    imgRecords.setOutImg(Boolean.TRUE.equals(request.getKeepMedia()) ? String.valueOf(responses.get("outImg")) : "");
